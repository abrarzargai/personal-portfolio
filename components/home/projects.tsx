    ...
    <>
      <div>
          ...
          <div className="ml-4 sm:mx-12 md:mx-16 grid grid-cols-12 gap-4 h-auto place-items-center items-center">
            <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
              <div className="items-center w-3/4 relative">
                ...
                <h1 className="mb-3 mt-6 text-4xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-1xl font-extrabold text-white leading-none ">
                  Something I have <span className="text-pink font-bold">built.</span>
                </h1>
            ...
            <div className="relative col-span-12 md:col-span-5 lg:col-span-6 flex flex-col">
              <div className="w-64 h-auto shadow-light-xl hover:shadow-light-3xl transform transition-all duration-300 hover:scale-110">
                <TextCards
                  heading="Frontend"
                  text="Designing beautiful, interactive user interfaces with flair. 🎨✨🖥️"
                  color="violet"
                />
              </div>
              <div className="w-64 h-auto my-4 sm:ml-40 sm:-my-6 lg:ml-60 lg:-my-10 shadow-light-xl hover:shadow-light-3xl transform transition-all duration-300 hover:scale-110 z-auto">
                <TextCards
                  heading="Backend"
                  text="Building robust server-side solutions with power and precision. 💻🔗🔧"
                  color="pink"
                />
              </div>
              <div className="w-64 h-auto shadow-light-xl hover:shadow-light-3xl transform transition-all duration-300 hover:scale-110">
                <TextCards
                  heading="Deployment"
                  text="Effortlessly deploying and managing apps in the cloud. ☁️🚀📦"
                  color="violet"
                />
              </div>
              <div className="w-64 h-auto my-4 sm:ml-40 sm:-my-6 lg:ml-60 lg:-my-10 shadow-light-xl hover:shadow-light-3xl transform transition-all duration-300 hover:scale-110 z-auto">
                <TextCards
                  heading="Python Bots"
                  text="Creating intelligent bots that automate and simplify tasks. 🤖🐍🔄"
                  color="pink"
                />
              </div>
              <div className="w-64 h-auto shadow-light-xl hover:shadow-light-3xl transform transition-all duration-300 hover:scale-110">
                <TextCards
                  heading="Fullstack"
                  text="Handling every aspect of development from frontend to backend. 🛠️🌐🔍"
                  color="violet"
                />
              </div>
            </div>
        ...
        <div className="relative h-auto sm:h-auto md:h-auto ml-4 sm:mx-12 md:mx-16" id="projects">
          ...
          <div className="flex justify-center mt-10 pt-20 lg:mt-4">
            <Button
              type="solid"
              text="Show me more! 🔥"
